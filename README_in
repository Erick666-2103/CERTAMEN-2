In this repository, you will find three data processing folders:
...
The Databruin environment was also used to facilitate data processing, making it user-friendly for those without extensive knowledge of Python.
